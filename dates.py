...
class ChineseDate:
    ...
    branches = ['Крыса', 'Бык', 'Тигр', 'Кролик', 'Дракон', 'Змея', 'Лошадь', 'Коза', 'Обезьяна', 'Петух', 'Собака', 'Свинья']
    ...
    def print_info(self):
        print("Григорианская дата: " + self.greg_date.to_string() )
        print("Китайский Новый год начался: " + self.ny_date.to_string() )
        print("")
        print("Цикл китайского года: " + str(self.year_cycle))
        print("Китайский год: " + str(self.year))
        print("Ветвь года: " + str(self.year_branch) + " (" +  self.branches[self.year_branch - 1] + ")")
        print("Элемент года: " + str(self.year_element) + " (" + self.elements[self.year_element - 1] + ")")
        print("")
